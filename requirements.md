...
## Create Developer user with programmatic access
...
terraform -version
```
5. Add following aliases to `~/.bash_aliases` file:
```
...
```
6. Install Terraform plugin for Pycharm

## Create Administrator user with programmatic access (optional, if you need to deal with IAM or other things)
1. Connect to [AWS console](https://aws.amazon.com/fr/console/)
2. Go to **IAM** service
